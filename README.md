...
A Certbot service is included. Certs can be updated by Crontab or Jenkins, using [ssl_renew.sh](ssl_renew.sh)
---
---
---
...
- [Hydroshare Usagemetrics](#hydroshare-usagemetrics)
  ...
  - [A Certbot service is included. Certs can be updated by Crontab or Jenkins, using ssl\_renew.sh](#a-certbot-service-is-included-certs-can-be-updated-by-crontab-or-jenkins-using-ssl_renewsh)
